...
export const SecuritySettingsPopup = ({ isOpen, onClose }) => {
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-background rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto p-6"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between p-6 border-b">
              <h2 className="text-2xl font-montserrat font-bold">Security Settings</h2>
            ...
            <div className="p-6 space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Lock className="h-5 w-5 text-admin" />
                    Change Password
                  </CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <div className="flex justify-end gap-4 p-6 border-t">
              ...
              <Button className="flex-1 bg-admin hover:bg-admin/90">
                Save Settings
              </Button>
            </div>
          </motion.div>
